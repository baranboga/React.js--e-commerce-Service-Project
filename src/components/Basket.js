      ...
      <form class="row g-3">
        ...
        <div class="col-12">
          <button type="submit" onClick={(e)=>{
            ...
            //Kullancının girmiş olduğu bilgilere göre backend de POST işlemi ile veriler gönderilir. 
            //Kullanıcı müşteri ise ustaya, kullanıcı usta ise müşteriye mail atılır.
            e.preventDefault()
            dispatch(buy())
            navigate("/registered")

          }} class="btn btn-primary">İlan ver</button>
        </div>
      </form>
      </div>
    </div>
